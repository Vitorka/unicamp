...
set_motors_speed:
    ...
    ldrb r4, [r0]               @Armazena em r4 a id do primeiro motor
    ldrb r5, [r1]               @Armazena em r5 a id do segundo motor

    cmp r4, #0                  @Compara para ver se o primeiro motor passado eh o motor 0
    ldreqb r4, [r0, #1]         @Caso seja 0, coloca em r4 a velocidade do motor 0
    ldreqb r5, [r1, #1]         @Caso seja 0, coloca em r5 a velocidade do motor 1
    ldrneb r5, [r0, #1]         @Caso nao seja 0, coloca em r4 a velocidade do motor 0
    ldrneb r4, [r1, #1]         @Caso nao seja 0, coloca em r5 a velocidade do motor 1
