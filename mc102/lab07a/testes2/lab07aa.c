 ...
 * dos comandos que cada programa ira executar, ele realiza o rearranjo da 
 * posicao 
...
int main()
{
    int i, j, k, l, m, n, posicoes, max_caixas, num_exec, num_prog, num_comand, 
    condicao, acidente = 0;
    ...
    for(k = 0, n = 0; (k < num_exec) && (acidente == 0); k++)
    {
        ...
        for(m = 0; (comando[l][m] != '*') && (acidente == 0); m++, i = 0)
        {
            condicao = 0;
            
            /*Condicionais que definem se o comando seguinte a alguma delas 
             *            sera ou nao executado, de acordo com a cor da caixa 
             * que o braco 
             *            esta segurando ou se ele esta segurando alguma caixa*/
            if((comando[l][m] == 'B') && (braco == 'B'))
            {
                condicao = 1;
                m++;
            }
            else if((comando[l][m] == 'G') && (braco == 'G'))
            {
                condicao = 1;
                m++;
            }
            else if((comando[l][m] == 'Y') && (braco == 'Y'))
            {
                condicao = 1;
                m++;
            }
            else if((comando[l][m] == 'A') && (braco != '0'))
            {
                condicao = 1;
                m++;
            }
            else if((comando[l][m] == 'N') && (braco == '0'))
            {
                condicao = 1;
                m++;
            }
            else if((comando[l][m] == 'L') || (comando[l][m] == 'R') || 
                (comando[l][m] == 'D'))
            {
                condicao = 1;
            }
            ...
            if(condicao == 1)
            {
                ...
                if((comando[l][m] == 'L') && (n != 0))
                {
                    /*Identifica se houve um acidente*/
                    if((caixas[0][n - 1] != '.') && (braco != '0'))
                    {
                        acidente = 1;
                    }
                    else
                ...
                else if((comando[l][m] == 'R') && (n != posicoes - 1))
                {
                    /*Identifica se houve um acidente*/
                    if((caixas[0][n + 1] != '.') && (braco != '0'))
                    {
