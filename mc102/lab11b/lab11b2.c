...
void procura_nomes(time_t *timesChave, int *jk)
{
    int i, flag = 0;
    char aux[21];
...
void leResultadosChave(time_t timesChave[], int confrontoDireto[][6]) {
    ...
    int i, j, k, l, pontos_totais1, pontos_totais2; 
    ...
    {    
        ...
        procura_nomes(timesChave, &j);
        procura_nomes(timesChave, &k);
