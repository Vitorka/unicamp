...
function fileNotFound {
	...
	echo "Lembrando que os arquivos devem ser nomeados: main.c, lab06.c, lab06.h e devem "
...
if [[ ! -f "main.c" ]]; then
	fileNotFound
	exit
else if [[ ! -f "lab06.h" ]]; then
	fileNotFound
	exit
else if [[ ! -f "lab06.c" ]]; then
	fileNotFound
	exit
fi
fi
